...
export function Plugins({}) {
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex items-center gap-2 overflow-auto border-b bg-background p-1">
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex-1" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block h-full w-full overflow-auto px-8 py-4 focus:outline-none"
                />
              </div>
            </div>
          }
