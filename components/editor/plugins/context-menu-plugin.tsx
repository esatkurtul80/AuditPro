...
export function ContextMenuPlugin(): JSX.Element {
  ...
  const items = useMemo(() => {
    return [
      new NodeContextMenuOption(`Bağlantıyı Kaldır`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Kopyala`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Yapıştır`, {
        $onSelect: () => {
      ...
      new NodeContextMenuOption(`Düz Metin Olarak Yapıştır`, {
        $onSelect: () => {
          if (!navigator.clipboard || !navigator.clipboard.read) {
            return
          }
      ...
      new NodeContextMenuSeparator(),
      new NodeContextMenuOption(`Düğümü Sil`, {
        $onSelect: () => {
