...
export default function QuestionsPage() {
    ...
    return (
        <div className="container mx-auto py-4 md:py-8 px-4 md:px-6">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        Farklı türde sorular oluşturun ve bölümlere atayın
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Tüm Sorular</CardTitle>
                    <CardDescription>{questions.length} soru</CardDescription>
                </CardHeader>
                <CardContent>
                    <DataTable columns={columns} data={questions} searchKey="Soru" searchPlaceholder="Soru ara..." />
                </CardContent>
            </Card>
