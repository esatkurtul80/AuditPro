...
// Recharts removed due to React 19 incompatibility
// Using simple alternatives instead
import {
    ChartConfig,
    ChartContainer,
    ChartTooltip,
...
export function AuditorPerformanceContent() {
    ...
    // Sabit yıl listesi (2025-2036)
    const getAvailableYears = (): number[] => {
        return [2025, 2026, 2027, 2028, 2029, 2030, 2031, 2032, 2033, 2034, 2035, 2036];
    };
                                        ...
                                        <div className="space-y-3">
                                            {hawkDoveData.map((item, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="w-12 text-right font-bold text-sm">{item.score.toFixed(0)}</div>
                                                </div>
                                            ))}
                                            <div className="flex items-center gap-2 text-sm text-muted-foreground mt-4 pt-2 border-t">
                                                <span>Genel Ortalama:</span>
                                                <span className="font-bold text-destructive">{globalAverage.toFixed(1)}</span>
                                            </div>
                                        </div>
                                    ) : (
