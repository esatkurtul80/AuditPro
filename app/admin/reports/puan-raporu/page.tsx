...
export default function PuanRaporuPage() {
    ...
    const chartColumns: ColumnDef<MonthlyScoreRow>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                const chartData = MONTH_NAMES.map((m, i) => ({ month: m, score: row.original.months[i] }));

                return (
                    <div className="h-[250px] w-full min-w-[600px] p-2">
                                    ...
                                    toolbar={
                                        <div className="flex w-full gap-2">
                                            ...
                                            >
                                                ...
                                                {viewMode === "table" ? "Grafik Görünümü" : "Tablo Görünümü"}
                                            </Button>
