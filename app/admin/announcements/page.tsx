        ...
        const fetchOptions = async () => {
            try {
                ...
                const staticGroups: RecipientOption[] = [
                    ...
                    { id: "group_magaza", label: "Tüm Mağazalar", type: "role_group", value: "magaza", count: 0 },
                    { id: "group_denetmen", label: "Tüm Denetmenler", type: "role_group", value: "denetmen", count: 0 },
                    { id: "group_bolge_muduru", label: "Tüm Bölge Müdürleri", type: "role_group", value: "bolge-muduru", count: 0 },
                ]
                ...
                const regionOptions: RecipientOption[] = regionalManagerIds.map(rmId => {
                    ...
                    return {
                        id: `region_${rmId}`,
                        label: rmUser ? `Bölge: ${rmUser.displayName}` : "Bilinmeyen Bölge Yöneticisi",
                        type: "region_group",
                        value: rmId,
                        count: storeCount
                    }
