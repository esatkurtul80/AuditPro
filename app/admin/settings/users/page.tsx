...
export default function UserSettingsPage() {
  ...
  const getRoleDisplayName = (role: string) => {
    switch (role) {
      ...
      case 'rapor-yoneticisi': return 'Rapor Yöneticisi';
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                >
                  ...
                  <option value="rapor-yoneticisi">Rapor Yöneticisi</option>
                            ...
                            <td className="p-4 text-right">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-[200px]">
                                  ...
                                  <DropdownMenuItem onClick={(e) => { e.stopPropagation(); handleRoleUpdate(user.uid as string, "rapor-yoneticisi"); }} className="cursor-pointer gap-2">
                                    <Activity className="h-4 w-4 text-teal-600" /> Rapor Yöneticisi Yap
                                  </DropdownMenuItem>
